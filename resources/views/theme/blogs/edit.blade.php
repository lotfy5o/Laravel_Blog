            ...
            <div class="col-12">
                ...
                <form action="{{ route('blogs.update', ['blog' => $blog])}}" class="form-contact contact_form" method="post" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input class="form-control border" name="name" placeholder="Enter Your Blog Title" type="text" value="{{ $blog->name }}">
                    ...
                    <div class="form-group">
                        <textarea class="w-100 border" name="description" placeholder="Enter Your Blog" rows="5">{{ $blog->description }}</textarea>
